                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img class="d-block img-fluid" src="images/googlehome1.jpg" alt="First slide" width="100%">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="images/googlehome2.jpg" alt="Second slide" width="100%">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="images/googlehome3.jpg" alt="Third slide" width="100%">
                        </div>
                    </div>
            ...
            <div class="col-xs-12 col-md-6 pl-5 align-self-center">
                <div class="row">
                    <div class="col-md-12 mt-0">
                        <h2 class="center">Google Home</h2>
                    </div>
                </div>
                <div class="row">
                    <p class="center mt-4">Listen to music, playlists and more, and get rich sound from Google Home’s high excursion speaker.</p>
                </div>
                <div class="row mt-4">
                    <div class="col-6">
                        <small>colors</small>
