                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img class="d-block img-fluid" src="images/nestsmoke.jpg" alt="First slide" width="100%">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="images/nestsmoke2.jpg" alt="Second slide" width="100%">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="images/nestsmoke3.jpg" alt="Third slide" width="100%">
                        </div>
                    </div>
            ...
            <div class="col-xs-12 col-md-6 pl-5 align-self-center">
                <div class="row">
                    <div class="col-md-12 mt-0">
                        <h2 class="center">Nest Smoke Detector</h2>
                    </div>
                </div>
                <div class="row">
                    <p class="center mt-4">Nest Protect has a friendly human voice that gives you an early warning. That way you can handle burning toast before it becomes a burning toaster.</p>
                </div>
                <div class="row mt-4">
                    <div class="col-6">
                        <small>colors</small>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-2">
                <img class="img-responsive" width="100%" src="images/nestthermo2.jpg">
            </div>
            <div class="col-xs-12 col-md-2">
