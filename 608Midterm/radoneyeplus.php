                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img class="d-block img-fluid" src="images/radoneye+1.jpg" alt="First slide" width="100%">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="images/radoneye+2.jpg" alt="Second slide" width="100%">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="images/radoneye+3.jpg" alt="Third slide" width="100%">
                        </div>
                    </div>
            ...
            <div class="col-6 pl-5 align-self-center">
                <div class="row">
                    <div class="col-md-12 mt-0">
                        <h2 class="center">RadonEye Plus</h2>
                    </div>
                </div>
                <div class="row">
                    <p class="center mt-4">Radon Eye Plus is a real-time smart indoor radon gas detector using Wi-Fi communication. </p>
                </div>
                <div class="row mt-4">
                    <div class="col-6">
                        <small>colors</small>
